...
export const translations = {
  fr: {
    ...
    height_data_note_swisstopo: '🏢 Données de hauteur officielles (swisstopo 🇨🇭, mises à jour en juillet 2026) : 100 % des bâtiments mesurés.',
  ...
  de: {
    ...
    height_data_note_swisstopo: '🏢 Offizielle Höhendaten (swisstopo 🇨🇭, aktualisiert im Juli 2026): 100 % der Gebäude vermessen.',
  ...
  it: {
    ...
    height_data_note_swisstopo: '🏢 Dati di altezza ufficiali (swisstopo 🇨🇭, aggiornati a luglio 2026): 100 % degli edifici misurati.',
  ...
  en: {
    ...
    height_data_note_swisstopo: '🏢 Official height data (swisstopo 🇨🇭, updated July 2026): 100% of buildings measured.',
