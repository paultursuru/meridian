...
export const translations = {
  fr: {
    ...
    height_data_note: '🏢 Données de hauteur : {pct} % des bâtiments (le reste est estimé).',
  ...
  de: {
    ...
    height_data_note: '🏢 Höhendaten: {pct} % der Gebäude (Rest geschätzt).',
  ...
  it: {
    ...
    height_data_note: '🏢 Dati di altezza: {pct} % degli edifici (il resto è stimato).',
  ...
  en: {
    ...
    height_data_note: '🏢 Height data: {pct}% of buildings (rest estimated).',
